function manip() {
    ...
    var cutoff = (mt + pt/2 + ct/2).toFixed(2);
    var total = ((ten_avg*6)+t11+e11+m11+p11+c11+b11+t12+e12+m12+p12+c12+b12).toFixed(1);
...
function PrintDiv() 
   {  
       ...
       printWindow.document.write ('<h1 style="color: #2962ff;">VELALAR COLLEGE OF ENGINEERING AND TECHNOLOGY</h1><br><br><h2>12th Cutoff Calculation</h2>');
